...
class RealtimeTurnLedger:
    ...
    * Repeating the same key with a different command is a protocol
    ...
    def command_digest(
        ...
        cleaned = cls.normalise_command(command)
    ...
    def claim(
        ...
        *,
        ...
        cleaned_command = self.normalise_command(command)
        ...
        digest = self.command_digest(cleaned_command)
        ...
        with self._lock:
            ...
            try:
                ...
                disposition = "duplicate" if existing.command_sha256 == digest else "conflict"
        ...
        *,
        ...
        with self._lock:
            ...
            if cursor.rowcount != 1:
                raise KeyError("realtime turn does not exist")
        ...
        if record is None:
            raise RuntimeError("updated realtime turn disappeared")
