...
class RealtimeTurnLedgerTests(unittest.TestCase):
    def setUp(self) -> None:
        self.temp = tempfile.TemporaryDirectory()
        self.path = Path(self.temp.name) / "turns.db"
    ...
    def test_reusing_id_for_different_command_is_conflict(
        ...
        try:
            ...
            self.assertTrue(claim.is_conflict)
        finally:
            ledger.close()
    ...
    def test_claim_survives_database_reopen(
        ...
        try:
            ...
            self.assertTrue(claim.is_duplicate)
        finally:
            second.close()
    ...
    def test_prune_removes_old_records(
        ...
        try:
            ...
            removed = ledger.prune(max_age_seconds=50.0)
