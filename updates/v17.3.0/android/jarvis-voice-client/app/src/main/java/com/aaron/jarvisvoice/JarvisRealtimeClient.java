...
public final class JarvisRealtimeClient {
    public interface Listener {
        void onConnected();
        void onReady(String model, String voice, String voiceMode, boolean unifiedBrain);
        ...
        void onBrainResponse(String text, boolean success);
    ...
    private void handleText(String raw) {
        ...
        switch (event.type) {
            ...
            case "brain.response" -> post(() -> listener.onBrainResponse(event.text, event.success));
