...
public final class SettingsActivity extends Activity {
    ...
    private View buildContent() {
        ...
        page.addView(buildIntegrationsCard(), matchWrap(0, dp(24)));

        page.addView(sectionHeader(
            "Developer",
            "Secure Codex sessions on the Jarvis Ubuntu PC."
        ), matchWrap(0, dp(10)));
    ...
    private View buildIntegrationsCard() {
        ...
        section.addView(content, matchWrap());
        return section;
    }
